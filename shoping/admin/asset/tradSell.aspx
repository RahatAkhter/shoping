<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="tradSell.aspx.cs" Inherits="shoping.admin.asset.tradSell" %>
<asp:Content ID="Content1" ContentPlaceHolderID="c2" runat="server">
      ...
      <div class="container-fluid">
                    <br />
                <h2 style="text-align:center;" class="title-head">Seller <span>Bitcoins</span></h2>
