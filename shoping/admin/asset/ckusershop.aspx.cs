...
{
    public partial class ckusershop : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from cryptoshop ";
            cmd.ExecuteNonQuery();
        ...
        protected void b1_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandType = CommandType.Text;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from cryptoshop where  BuyerGmail = '" + TextBox4.Text + "' ";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
