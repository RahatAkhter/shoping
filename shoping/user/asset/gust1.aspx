<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.Master" AutoEventWireup="true" CodeBehind="gust1.aspx.cs" Inherits="shoping.user.asset.gust1" %>
...
<div class="form-container" style="width:50%; margin-left:auto;margin-right: auto; "  >
    ...
    <div class="form-group">
          <asp:TextBox ID="TextBox3" runat="server" TextMode="Url" placeholder="Product Url"  class="form-control"></asp:TextBox>
	</div>
    <div class="form-group">
          <asp:TextBox ID="TextBox4" runat="server"  TextMode="Email" placeholder="Enter Your Gmail"  class="form-control"></asp:TextBox>
	</div>
    <div class="form-group">
          <asp:TextBox ID="TextBox5" runat="server"  placeholder="Enter Your Phone Number"  TextMode="Number"  class="form-control"></asp:TextBox>
	</div>
	<div class="form-group">
          <asp:TextBox ID="TextBox6" runat="server"  placeholder="Enter Your Address"   class="form-control"></asp:TextBox>
	</div>
        <div class="form-group">
