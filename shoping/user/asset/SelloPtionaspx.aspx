<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.Master" AutoEventWireup="true" CodeBehind="SelloPtionaspx.aspx.cs" Inherits="shoping.user.asset.SelloPtionaspx" %>
 ...
 <link href="css/table.css" rel="stylesheet" />
        ...
        <!-- Header Ends -->
                <div class="container-fluid">
                    <br />
                <h2 style="text-align:center;" class="title-head">SELL <span>Bitcoins</span></h2>
<asp:Repeater ID="r1" runat="server">
        ...
        <FooterTemplate>
               ...
               <asp:Button ID="chat" runat="server" Text="Chat" class="btn btn-primary" OnClick="chat_Click" Style="float:right;margin-right:50%"  />
