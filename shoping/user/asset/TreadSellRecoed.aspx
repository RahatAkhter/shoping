<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.Master" AutoEventWireup="true" CodeBehind="TreadSellRecoed.aspx.cs" Inherits="shoping.user.asset.TreadSellRecoed" %>
...
<div id="main">
   ...
   <asp:Repeater ID="r1" runat="server">
      <HeaderTemplate>
                ...
                <h2 style="text-align:center;" class="title-head">My <span>Bitcion Sell</span> Add</h2>
