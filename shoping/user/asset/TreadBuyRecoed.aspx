<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.Master" AutoEventWireup="true" CodeBehind="TreadBuyRecoed.aspx.cs" Inherits="shoping.user.asset.TreadBuyRecoed" %>
...
<div id="main">
   ...
   <asp:Repeater ID="r1" runat="server">
      <HeaderTemplate>
                ...
                <h2 style="text-align:center;" class="title-head">My <span>Bitcion Buy</span> Add</h2>
