<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.Master" AutoEventWireup="true" CodeBehind="trading.aspx.cs" Inherits="shoping.user.asset.trading" %>
...
<link href="css/table.css" rel="stylesheet" />
       <!-- Header Starts -->
        ...
        <ul class="dropdown-menu" style="text-align:left;border-left:solid 1px #ffffff;border-bottom:solid 1px #ffffff; border-right:solid 1px #ffffff;" >
          ...
          <li><a id="A4" runat="server" href="logout.aspx" >LOGOUT</a></li>
        </ul>
      </li>
                    ...
                    <div class="container">
                        ...
                        <div class="row text-center">
                            <div class="col-xs-12">
                                ...
                                <!-- Title Starts -->
                                <h2 class="title-head">Buy and Sell  <span>Bitcoins</span></h2>
                                <!-- Title Ends -->
                                
                                <!-- Breadcrumb Starts -->
                                <ul class="breadcrumb">
                                    <li><a id="A1" runat="server" href="~/user/asset/BuyC.aspx" class="btn btn-primary" style="color:antiquewhite;" >Buy Bitcoins</a></li>
                                    <li><a id="A3" runat="server" href="~/user/asset/SellCaspx.aspx" class="btn btn-primary" style="color:antiquewhite;">Sell Bitcoins</a></li>
    ...
    <div class="container-fluid">
        ...
        <br />
        <div class="container-fluid" style="border:solid  1px #ffffff; padding:15px 10px 15px 10px; width:85%;">
            <asp:Label ID="Label1" runat="server" Text="scerch"  Style="width:9%;  float:left;"></asp:Label>
          
            <asp:DropDownList ID="DDL1" runat="server" class="form-control" Style="width:18%; margin-left:2%; float:left; float:left;">
            ...
            <asp:DropDownList ID="DropDownList2" runat="server" class="form-control" Style="width:18%; margin-left:2%; float:left;">
            ...
            <asp:ListItem Value="ZWD">Zimbabwe Dollar</asp:ListItem>
                 ...
                 <asp:DropDownList ID="DropDownList3" runat="server" class="form-control" Style="width:18%; margin-left:2%; float:left;">
              ...
              <asp:TextBox ID="TextBox4" runat="server" placeholder="Enter Your Price" TextMode="Number" class="form-control" Style="width:18%; margin-left:2%; float:left;" ></asp:TextBox>
            <asp:Button ID="search" runat="server" class="btn btn-primary" Text="Search"  OnClick="search_Clivk" />
        </div>
        <br /><br />
<asp:Repeater ID="r1" runat="server">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td  style="width :30px;">
                    <a href="BuyOption.aspx?id=<%#Eval("id")%>" class="btn btn-primary" >BUY</a>
                   </td>
            </tr>
        </ItemTemplate>
    ...
    <div class="container-fluid">
                <h2 class="title-head">Sell <span>Bitcoins</span></h2>
        <br />
        <div class="container-fluid" style="border:solid  1px #ffffff; padding:15px 10px 15px 10px; width:85%;">
            <asp:Label ID="Label2" runat="server" Text="Search"  Style="width:9%;  float:left;"></asp:Label>
          
            <asp:DropDownList ID="DropDownList4" runat="server" class="form-control" Style="width:18%; margin-left:2%; float:left;">
                    <asp:ListItem Selected="true">Select Country</asp:ListItem>
                    <asp:ListItem>United States</asp:ListItem>
                    <asp:ListItem>Afghanistan</asp:ListItem>
                    <asp:ListItem>Albania</asp:ListItem>
            ...
            <asp:DropDownList ID="DropDownList5" runat="server" class="form-control" Style="width:18%; margin-left:2%; float:left;" >
            ...
            <asp:ListItem Value="ZWD">Zimbabwe Dollar</asp:ListItem>
                 ...
                 <asp:DropDownList ID="DropDownList6" runat="server" class="form-control" Style="width:18%; margin-left:2%; float:left;">
                    <asp:ListItem Selected="true">Select Payment Method</asp:ListItem>
                    <asp:ListItem>United States</asp:ListItem>
                    <asp:ListItem>Afghanistan</asp:ListItem>
                    <asp:ListItem>Albania</asp:ListItem>
              ...
              <asp:TextBox ID="TextBox1" runat="server" placeholder="Enter Your Price" TextMode="Number" class="form-control" Style="width:18%; margin-left:2%; float:left;" ></asp:TextBox>
            <asp:Button ID="search1" runat="server" class="btn btn-primary" Text="search"  OnClick="search1_Clivk" />
        </div>
        <br /><br />
...
<asp:Repeater ID="r2" runat="server">
        <HeaderTemplate>
            <table style="width:80%;margin-left:auto;margin-right:auto;" >
                <tr>
                    <th style=" font-size:18px; text-align:center;">Seller</th>
                    <th style=" font-size:18px; text-align:center;">Country</th>
                    <th style=" font-size:18px; text-align:center;">Currency</th>
                    <th style=" font-size:18px; text-align:center;">Payment Method</th>
                    <th style=" font-size:18px; text-align:center;" >Price / BTC	</th>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td style=" font-size:12px; text-align:left;"><%#Eval("limit") %></td>
                   <td  style="width :30px;">
                       <a href="SelloPtionaspx.aspx?id=<%#Eval("id")%>" class="btn btn-primary" >SELL</a>
                </td> 
            </tr>
        </ItemTemplate>
