<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.Master" AutoEventWireup="true" CodeBehind="SellCaspx.aspx.cs" Inherits="shoping.user.asset.SellCaspx" %>
            ...
            <asp:ListItem Value="ZWD">Zimbabwe Dollar</asp:ListItem>
                    ...
                    <asp:ListItem>Andorra</asp:ListItem>
                        ...
                        <!-- Submit Form Button Starts -->
							<div class="form-group">
                                <asp:Button ID="seller" runat="server" class="btn btn-primary" Text="OK"  OnClick="seller_Click"/>
								</div>
