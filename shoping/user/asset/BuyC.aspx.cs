...
{
    public partial class BuyC : System.Web.UI.Page
    {
        ...
        protected void BUY_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "insert into Buyer values('" + Session["email"] + "','" + Sel.Text + "','" + Sel1.Text + "','" + Select.Text + "','" + price.Text + "','" + limet.Text + "','" + date.Text + "') ";
            cmd.ExecuteNonQuery();
            Response.Redirect("trading.aspx");
        }
